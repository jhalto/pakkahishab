...
class BankAppbarBackWithSearch extends StatelessWidget
    implements PreferredSizeWidget {
  final String title;
  final ValueChanged<String>? onSearchChanged;

  BankAppbarBackWithSearch({
    super.key,
    required this.title,
          ...
          actions: [
            Consumer(
              builder: (context, ref, child) {
                final vm = ref.watch(stockViewModelProvider);
                      ...
                      items: [
                        PopupMenuItem(
                          onTap: () async {
                            ...
                            final vm = ref.read(stockViewModelProvider);
