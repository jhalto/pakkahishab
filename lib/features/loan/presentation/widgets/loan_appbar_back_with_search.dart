...
class LoanAppbarBackWithSearch extends StatelessWidget
    implements PreferredSizeWidget {
  final String title;
  final ValueChanged<String>? onSearchChanged;

  LoanAppbarBackWithSearch({
    super.key,
    required this.title,
          ...
          actions: [
            Consumer(
              builder: (context, ref, child) {
                final vm = ref.watch(loanViewModelProvider);
                        ...
                        PopupMenuItem(
                          onTap: () async {
                            final notifier = ref.read(
                              loanViewModelProvider.notifier,
                            );
                            final vm = ref.read(loanViewModelProvider);
