...
class MobileBankAppbarBackWithSearch extends StatelessWidget
    implements PreferredSizeWidget {
  final String title;
  final ValueChanged<String>? onSearchChanged;

  MobileBankAppbarBackWithSearch({
    super.key,
    required this.title,
          ...
          actions: [
            Consumer(
              builder: (context, ref, child) {
                final vm = ref.watch(mobileBankViewModelProvider);
                        ...
                        PopupMenuItem(
                          onTap: () async {
                            final notifier = ref.read(
                              mobileBankViewModelProvider.notifier,
                            );
                            final vm = ref.read(mobileBankViewModelProvider);

                            if (vm.stockProductName == null ||
                                (vm.stockProductName?.items.isEmpty ?? true)) {
                              notifier.getStockProductName();
                            }
