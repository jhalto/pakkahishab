...
import 'package:pakkahishab/features/mobile_banking/presentation/viewmodels/mobile_bank_viewmodel.dart';


import 'package:pakkahishab/features/mobile_banking/presentation/widgets/mobile_bank_appbar_back_with_search.dart';





class MobileBankView extends StatelessWidget {
  const MobileBankView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MobileBankAppbarBackWithSearch(title: "Mobile Banking"),
      body: SafeArea(
        child: Consumer(
          builder: (context, ref, child) {
            return RefreshIndicator(
              ...
              onRefresh: () {
                return ref
                    .read(mobileBankViewModelProvider.notifier)
                    .refreshSales();
              },
              child: Consumer(
                builder: (outerContext, ref, child) {
                  final incomeState = ref.watch(mobileBankViewModelProvider);

                  if (incomeState.loading) {
                    return Center(child: loader);
                  }
                  if (incomeState.mobileBankItem.isEmpty) {
                    ...
                    children: [
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      incomeState.mobileBankItem.isEmpty
                                          ? "0"
                                          : ref
                                                .watch(mobileBankViewModelProvider)
                                                .mobileBankItem
                                                .length
                                                .toString(),
                                      style: AppTextStyle.labelLarge,
                      ...
                      Expanded(
                        child: ListView.builder(
                          itemCount: incomeState.mobileBankItem.length,
                          itemBuilder: (context, index) {
                            final item = incomeState.mobileBankItem[index];
                                              ...
                                              Column(
                                               ...
                                               Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    item.credit.toString(),style: AppTextStyle.bodySmall,
                                                  ),
                                                ],
                                              ),
                                            ],
...
class _SalesPaginationState extends ConsumerState<SalesPagination> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final currentPage = ref.read(mobileBankViewModelProvider).currentPage;
      if (currentPage > 1) {
  ...
  @override
  Widget build(BuildContext context) {
    final purchaseState = ref.watch(mobileBankViewModelProvider);
    final notifier = ref.read(mobileBankViewModelProvider.notifier);
