...
final mobileBankServiceProvider = Provider<MobileBankServices>(
  (ref) => MobileBankServices(),
);

class MobileBankServices {
  Future<Map<String, dynamic>> getMobileBankAmountItem({
    ...
    final String url = "${Urls.baseUrl}Get_Mobile_Banking/";
    try {
