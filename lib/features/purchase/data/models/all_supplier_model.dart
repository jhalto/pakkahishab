  ...
  factory AllSupplierModel.fromJson(Map<String, dynamic> json) {
    return AllSupplierModel(
      items: json['items'] != null
          ? List<AllSupplier>.from(
              json['items'].map((x) => AllSupplier.fromJson(x)),
            )
          : [],
...
class AllSupplier {
  ...
  factory AllSupplier.fromJson(Map<String, dynamic> json) {
    return AllSupplier(
      supplierAccountNo: json['account_no'] ?? 0,
