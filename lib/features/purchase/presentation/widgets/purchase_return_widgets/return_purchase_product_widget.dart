...
class ReturnPurchaseProductWidget extends ConsumerWidget {
  const ReturnPurchaseProductWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final updateVmn = ref.watch(purchaseReturnViewModel.notifier);
    final updateVm = ref.watch(purchaseReturnViewModel);
