                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      vmn.selectedPurchaseProductId =
                                          product.productId;
                                      vmn.selectedPurchaseProductName =
                                          product.productName;
                                      vmn.selectedPurchaseProductPrice = product
                                          .unitPrice
                                          .toString();
                                      vmn.purchaseProductQuantity.text = product
                                          .quantity
                                          .toString();
                                      navigateWithSlide(
                                        context: context,
                                  ...
                                  InkWell(
                                    onTap: () {
                                      vmn.deleteProductFromPurchase(
                                        context,
                                        index: index,
                                        purchaseId: purchaseHead.purchaseId
                                            .toString(),
                                        purchaseNo: purchaseHead.purchaseNo,
                                      );
                                    },
